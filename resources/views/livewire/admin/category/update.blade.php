...
<!--begin::Modal-->
<div wire:ignore.self class="modal fade" id="CategoryUpdateModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content rounded">
            ...
            <form>
                ...
                <div class="modal-footer">
                    <button type="button" wire:click.prevent="updateCategory()" class="btn btn-primary" data-bs-dismiss="modal">ذخیره</button>
