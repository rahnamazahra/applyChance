...
<!--begin::Modal-->
<div wire:ignore.self class="modal fade" id="CountryUpdateModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-body">
                <input type="hidden" class="form-control form-control-solid" wire:model.defer="id"/>
            ...
            <div class="modal-footer">
                <button type="button" wire:click.prevent="updateCountry()" class="btn btn-primary" data-bs-dismiss="modal">ذخیره</button>
