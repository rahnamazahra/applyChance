                    ...
                    @foreach($countries as $country)
                        <tr>
                            ...
                            <td class="text-center">
                             ...
                             <td class="text-center">
                                <div class="position-relative ps-6 pe-3 py-2">
                                    <span class="mb-1 text-dark"> {{ $country->slug }}</span>
                                </div>
                            </td>
                            <td class="text-center">
                                <div class="btn btn-group-sm">
                                    <button data-bs-toggle="modal" data-bs-target="#CountryUpdateModal" wire:click="editCountry({{ $country->id }})"  class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ویرایش">
                                    ...
                                    <button data-bs-toggle="modal" data-bs-target="#CountryDeleteModal" wire:click= "ConfirmDeleteCountry({{$country->id}})" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="حذف">
                                        <span class="svg-icon svg-icon-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
