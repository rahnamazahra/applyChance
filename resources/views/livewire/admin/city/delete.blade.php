<button data-bs-toggle="modal" data-bs-target="#CityDeleteModal" wire:click= "deletestep1City({{$city->id}})" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="حذف">
