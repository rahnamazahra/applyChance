            ...
            <form>
               <div class="modal-body">
                    ...
                    <div class="col-md-12 fv-row">
                        ...
                        <input type="text" data-jdp type="text" class="form-control form-control-solid" autocomplete="off" wire:model.lazy="published" id="published" name="published" placeholder="تاریخ انتشار را وارد نمایید"/>
