...
<!--begin::Modal-->
<div wire:ignore.self class="modal fade" id="PositionDeleteModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-footer">
                <button type="button" wire:click.prevent="deletePosition()" class="btn btn-primary" data-bs-dismiss="modal">بله</button>
