...
<!--begin::Modal-->
<div wire:ignore.self class="modal fade" id="TeacherUpdateModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content rounded">
            ...
            <form>
                        ...
                        <div wire:ignore>
                            <div class="form-group">
                                <div class="input-group">
                                    <label for="field_id" class="required d-flex align-items-center fs-6 fw-bold mb-2">نام کشور </label>
                                    <select class="form-select form-select-solid" wire:model.defer="field_id" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                        ...
                                        @foreach($fields as $title=>$id)
                                            <option value="{{ $id }}" @if( $this->field_id == $id) selected @endif>{{ $title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    <button type="button" wire:click.prevent="updateTeacher()" class="btn btn-primary" data-bs-dismiss="modal">ذخیره</button>
