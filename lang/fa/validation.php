...
return [
    ...
    'attributes' => [
        ...
        'executor_id'           => 'مجری',
        'broker_id'             => 'کارگزار مالی',
        'patronage_id'          => 'نوع حمایت',
        'contract_number'       => 'شماره قرارداد',
        'contract_date'         => 'تاریخ عقد قرارداد',
        'national_code'         => 'کدملی',
        'receiver_id'           => 'دریافت کننده',
        'subject_id'            => 'موضوع پرداخت',
        'agreement_date'        => 'تاریخ موافقت نامه',
        'agreement_number'      => 'شماره موافقت نامه',
        'roles'                 => 'نقش(ها)',
        'payment_cost'          => 'مبلغ پرداخت',
